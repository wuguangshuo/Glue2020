...
if __name__=='__main__':
    ...
    #将训练集划分训练集和验证集
    word_train, word_val, label_train, label_val = utils.val_split(config.train_dir)
    train_dataset=NERDataset(word_train,label_train,config)
    val_dataset = NERDataset(word_val, label_val, config)
    ...
    train(train_loader, val_loader, model, optimizer, scheduler, config.model_dir)
